                        ...
                        <div class="col-lg-12">
                            <div class="view-header">
                                ...
                                <div class="header-title">
                                    <h3 class="m-b-xs">Presentaciones</h3>
                        ...
                        <div class="col-md-12 col-lg-6">
                            <div class="panel panel-filled">
                                <div class="panel-heading">
                                    ...
                                    Editar presentaci&oacute;n
                                </div>
                                <div class="panel-body">
                                    <?php
                                        if(isset($data['sublocation']) && isset($data['location'])){
                                            $sublocation = filter_var($data['location'],FILTER_SANITIZE_STRING);
                                            $formAction = Doo::conf()->APP_URL . 'presentacion/'.$sublocation.'/actualizar/';
                                        }else{
                                            $formAction = Doo::conf()->APP_URL . 'presentacion/actualizar/';
                                        }
                                    ?>
                                    <form method="POST" action="<?php echo $formAction.$d->id_descarga; ?>" enctype="multipart/form-data" id="descarga-form">
                                        ...
                                        <div class=form-group>
                                            ...
                                            <textarea class="form-control" rows="3" placeholder="descripcion" name="descripcion" id="descripcion"><?php echo utf8_encode($d->descripcion); ?></textarea>
                                        </div>
                                         <div class=form-group>
