...
<html>
                        ...
                        <div class="col-lg-12">
                            <div class="view-header">
                                ...
                                <div class="header-title">
                                    <h3 class="m-b-xs">Presentaciones <?php
                                                    ...
                                                    ?></h3>
                                    <small>Aqu&iacute; podr&aacute;s administrar las presentaciones publicadas en la App de TelevisaConnect.</small>
                                </div>
                            </div>
                            <hr>
                        </div>
                        ...
                        <div class="col-md-12 col-lg-6">
                            <div class="panel panel-filled">
                                <div class="panel-heading">
                                    ...
                                    Publicar una presentaci&oacute;n
                                </div>
                                <div class="panel-body">
                                    <p>Para publicar un presentaci&oacute;n en la App de TelevisaConnect llena el siguiente formulario.</p>
                                    <?php 
                                        $formAction = Doo::conf()->APP_URL . 'presentacion/agregar';
                                        if(isset($data['location']) && isset($data['sublocation'])){
                                            $sublocation = filter_var($data['location'],FILTER_SANITIZE_STRING);
                                            $formAction = Doo::conf()->APP_URL . 'presentacion/'.$sublocation.'/agregar';
                                        }
                                    ?>
                                    <form method="POST" action="<?php echo $formAction; ?>" enctype="multipart/form-data" id="descarga-form">
                                        <div class=form-group>
                                            <label>T&iacute;tulo de la presentaci&oacute;n</label>
                                                        ...
                                                        <div class="buttons-container">
                                                            ...
                                                            <?php
                                                                if(isset($data['sublocation']) && isset($data['location'])){
                                                                    $editLocation = Doo::conf()->APP_URL . 'presentacion/'.$data['location'].'/editar/';
                                                                    $deleteLocation = Doo::conf()->APP_URL . 'presentacion/'.$data['location'].'/eliminar/';
                                                                }else{
                                                                    $editLocation = Doo::conf()->APP_URL . 'presentacion/editar/';
                                                                    $deleteLocation = Doo::conf()->APP_URL . 'presentacion/eliminar/';
                                                                }
                                                            ?>
                                                            <a href="<?php echo $editLocation . $descarga->id_descarga; ?>" class="btn btn-success">Editar</a>
    ...
    switch (intval($_GET['success'])) {
        case 1:
            $mensaje = '<strong>Presentación publicada</strong> <br/><small>Tu Presentación fue publicada en la App de TelevisaConnect.</small>';
            break;
        case 2:
            $mensaje = '<strong>Presentación eliminada</strong> <br/><small>Tu Presentación fue eliminada de la App de TelevisaConnect.</small>';
            break;
        default:
                ...
                setTimeout(function() {
                    ...
                    switch (intval($_GET['error'])){
                        case 1:
                            ...
                            break;
                        case 2:
                            $error = 'No existe la categoría Presentaciones.';
                            break;
                        case 3:
                            $error = 'La URL proporcionada no es una presentación válida';
                            break;
                        case 4:
