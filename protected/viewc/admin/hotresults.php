...
<html>
    <head>
        ...
        <!-- croppie -->
        <!-- Page title -->
        <title><?php echo Doo::conf()->APP_NAME; ?> | Hot+Results</title>
    </head>
    <body>
        <!-- Wrapper-->
        <div class="wrapper">
                        ...
                        <div class="col-lg-12">
                            <div class="view-header">
                                ...
                                <div class="header-title">
                                    <h3 class="m-b-xs">Hot+Results</h3>
                                    <small>Aqu&iacute; podr&aacute;s administrar los Hot+Results publicados en la App de TelevisaConnect.</small>
                                </div>
                            </div>
                            <hr>
                        </div>
                        ...
                        <div class="col-md-12 col-lg-6">
                            <div class="panel panel-filled">
                                <div class="panel-heading">
                                    ...
                                    Publicar un Hot+Result
                                </div>
                                <div class="panel-body">
                                    <p>Para publicar un Hot+Results en la App de TelevisaConnect llena el siguiente formulario.</p>
                                    <form method="POST" action="<?php echo Doo::conf()->APP_URL . 'hot-results/agregar'; ?>" enctype="multipart/form-data">
                                        <div class=form-group>
                                            <label>T&iacute;tulo del Hot+Results</label>
                                                ...
                                                <div class="panel panel-filled panel-c-accent panel-collapse">
                                                    ...
                                                    <div class="panel-footer" style="display:none;">
                                                        ...
                                                        <div class="buttons-container">
                                                            ...
                                                            <a href="<?php echo Doo::conf()->APP_URL . 'hot-results/editar/' . $descarga->id_descarga; ?>" class="btn btn-success">Editar</a>
                                                            <a href="<?php echo Doo::conf()->APP_URL . 'hot-results/eliminar/' . $descarga->id_descarga; ?>" class="btn btn-danger">Eliminar</a>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
    ...
    switch (intval($_GET['success'])) {
        case 1:
            $mensaje = '<strong>Hot+Results publicado</strong> <br/><small>Tu Hot+Results fue publicado en la App de TelevisaConnect.</small>';
            break;
        case 2:
            $mensaje = '<strong>Hot+Results eliminado</strong> <br/><small>Tu Hot+Results fue eliminado de la App de TelevisaConnect.</small>';
            break;
        default:
