...
<html>
                        ...
                        <div class="col-md-12 col-lg-6">
                            <div class="panel panel-filled">
                                ...
                                <div class="panel-body">
                                    <p>Para publicar un iBook en la App de TelevisaConnect llena el siguiente formulario.</p>
                                    <?php
                                        if(isset($data['sublocation']) && isset($data['location'])){
                                            $formAction = Doo::conf()->APP_URL . 'ibook/'.$data['location'].'/agregar';
                                        }else{
                                            $formAction = Doo::conf()->APP_URL . 'ibook/agregar';
                                        }
                                    ?>
                                    <form method="POST" action="<?php echo $formAction; ?>" enctype="multipart/form-data">
                                        ...
                                        <div class=form-group>
                                            ...
                                            <input type="text" class="form-control" name="url" id="url" placeholder="http://ejemplo.com/url-del-ibook.ibook" maxlength="250">
                                        </div>
                                        <br/>
                                                ...
                                                <div class="panel panel-filled panel-c-accent panel-collapse">
                                                    ...
                                                    <div class="panel-footer" style="display:none;">
                                                        ...
                                                        <div class="buttons-container">
                                                            <a href="<?php echo $descarga->url; ?>" target="_blank" class="btn btn-success">Descargar</a>
                                                            <?php
                                                                if(isset($data['sublocation']) && isset($data['location'])){
                                                                    $editLocation = Doo::conf()->APP_URL . 'ibooks/'.$data['location'].'/editar/';
                                                                    $deleteLocation = Doo::conf()->APP_URL . 'ibooks/'.$data['location'].'/eliminar/';
                                                                }else{
                                                                    $editLocation = Doo::conf()->APP_URL . 'ibooks/editar/';
                                                                    $deleteLocation = Doo::conf()->APP_URL . 'ibooks/eliminar/';
                                                                }
                                                            ?>
    ...
    switch (intval($_GET['success'])) {
        case 1:
            $mensaje = '<strong>iBook publicado</strong> <br/><small>Tu iBook fue publicado en la App de TelevisaConnect.</small>';
            break;
        case 2:
            $mensaje = '<strong>iBook eliminado</strong> <br/><small>Tu iBook fue eliminado de la App de TelevisaConnect.</small>';
            break;
        default:
