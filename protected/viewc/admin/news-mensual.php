                        ...
                        <div class="col-lg-12">
                            <div class="view-header">
                                ...
                                <div class="header-title">
                                    <h3 class="m-b-xs">Newsletter Mensual</h3>
                        ...
                        <div class="col-md-12 col-lg-6">
                            <div class="panel panel-filled">
                                <div class="panel-heading">
                                    ...
                                    Publicar un Newsletter Mensual 
                                </div>
                                <div class="panel-body">
                                    <p>Para publicar un Newsletter Mensual en la App de TelevisaConnect llena el siguiente formulario.</p>
                                    <form method="POST" action="<?php echo Doo::conf()->APP_URL . 'newsletter/agregar'; ?>" enctype="multipart/form-data">
                                        <input type="hidden" name="categoria" id="categoria" value="news-mensual">
                                        <div class=form-group>
                                            <label>T&iacute;tulo del Newsletter Mensual</label>
                                                ...
                                                <div class="panel panel-filled panel-c-accent panel-collapse">
                                                    ...
                                                    <div class="panel-footer" style="display:none;">
                                                        ...
                                                        <div class="buttons-container">
                                                            ...
                                                            <a href="<?php echo Doo::conf()->APP_URL . 'newsletter/editar/' . $descarga->id_descarga.'/news-mensual'; ?>" class="btn btn-success">Editar</a>
                                                            <a href="<?php echo Doo::conf()->APP_URL . 'newsletter/eliminar/' . $descarga->id_descarga.'/news-mensual'; ?>" class="btn btn-danger">Eliminar</a>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
