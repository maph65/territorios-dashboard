...
<html>
    <head>
        ...
        <!-- croppie -->
        <!-- Page title -->
        <title><?php echo Doo::conf()->APP_NAME; ?> | Cata&aacute;logos</title>
    </head>
    <body>
        <!-- Wrapper-->
        <div class="wrapper">
                        ...
                        <div class="col-md-12 col-lg-6">
                            <div class="panel panel-filled">
                                <div class="panel-heading">
                                    ...
                                    Publicar un Cat&aacute;logo
                                </div>
                                <div class="panel-body">
                                    <p>Para publicar un catálogo en la App de TelevisaConnect llena el siguiente formulario.</p>
                                    <form method="POST" action="<?php echo Doo::conf()->APP_URL . 'catalogos/agregar'; ?>" enctype="multipart/form-data">
                                                ...
                                                <div class="panel panel-filled panel-c-accent panel-collapse">
                                                    ...
                                                    <div class="panel-footer" style="display:none;">
                                                        ...
                                                        <div class="buttons-container">
                                                            ...
                                                            <a href="<?php echo Doo::conf()->APP_URL . 'catalogos/editar/' . $descarga->id_descarga; ?>" class="btn btn-success">Editar</a>
                                                            <a href="<?php echo Doo::conf()->APP_URL . 'catalogos/eliminar/' . $descarga->id_descarga; ?>" class="btn btn-danger">Eliminar</a>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
